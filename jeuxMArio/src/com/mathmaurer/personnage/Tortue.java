...
public class Tortue extends Cheban implements Runnable {
	...
	public Tortue(int x, int y) {
		...
		super.setWalke(true);
		this.zombie = false;
		this.icoTortue = new ImageIcon(getClass().getResource("/images/champArretDroite.png"));
	...
	public void setIcoTortue(ImageIcon icoTortue) {
		this.icoTortue = icoTortue;
	}

	public void setImageTortue(Image imageTortue) {
		this.imageTortue = imageTortue;
	}
...
//		super.pause = false;
	...
	public Image die() {
		super.setHeight(23);
		super.setWidth(25);
		ImageIcon icoTortueMort = new ImageIcon(getClass().getResource("/images/tortueFermee.png"));
